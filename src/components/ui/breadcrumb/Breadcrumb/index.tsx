...
import { BreadcrumbItem } from '@/components/ui/breadcrumb/BreadcrumbItem/index'
import {
	BreadcrumbProps,
	BreadcrumbJson,
} from '@/components/ui/breadcrumb/Breadcrumb/type'
					...
					{breadcrumbJson.map((item, index) => {
						return (
							<BreadcrumbItem
								...
								title={item.name}
								separator={index > 0 ? '>' : ''}
								isLink={breadcrumbJsonLength !== index + 1}
							/>
						)
					})}
				</ol>
